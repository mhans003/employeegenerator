...
const render = (employees, companyName) => {
    ...
    return renderMain(html.join(""), companyName);
...
const renderMain = (html, companyName) => {
    ...
    template = replacePlaceholders(template, "companyName", companyName); 
