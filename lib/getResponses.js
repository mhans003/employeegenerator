...
const getEmployeeInfo = employeeType => {
    //Retrieve further information from the user, knowing the employee type. 
    inquirer.prompt([
        {
            type: "input",
            message: `What is the ${employeeType[0].toLowerCase()}'s name?`,
            name: "name"
        },
        {
            type: "number",
            message: `What is the ${employeeType[0].toLowerCase()}'s ID number?`,
            name: "id",
            validate: validateNumber
        },
        {
            type: "input",
            message: `What is the ${employeeType[0].toLowerCase()}'s email?`,
            name: "email",
